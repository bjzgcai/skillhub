...
public class RouteSecurityPolicyRegistry {
    ...
    private static final List<RouteAuthorizationPolicy> AUTHORIZATION_POLICIES = List.of(
            ...
            RouteAuthorizationPolicy.permitAll(HttpMethod.POST, "/api/v1/auth/admin/exchange"),
            ...
            RouteAuthorizationPolicy.permitAll(HttpMethod.GET, "/api/v1/recommendations"),
            RouteAuthorizationPolicy.permitAll(HttpMethod.GET, "/api/v1/recommendations/weekly-current"),
            RouteAuthorizationPolicy.permitAll(HttpMethod.GET, "/api/v1/recommendations/weekly-history"),
            ...
            RouteAuthorizationPolicy.permitAll(HttpMethod.GET, "/api/web/recommendations"),
            RouteAuthorizationPolicy.permitAll(HttpMethod.GET, "/api/web/recommendations/weekly-current"),
            RouteAuthorizationPolicy.permitAll(HttpMethod.GET, "/api/web/recommendations/weekly-history"),
    ...
    private static final List<ApiTokenPolicy> API_TOKEN_POLICIES = List.of(
            ...
            ApiTokenPolicy.allow(HttpMethod.GET, "/api/web/skills/**"),
            ApiTokenPolicy.allow(HttpMethod.GET, "/api/v1/recommendations"),
            ApiTokenPolicy.allow(HttpMethod.GET, "/api/v1/recommendations/weekly-current"),
            ApiTokenPolicy.allow(HttpMethod.GET, "/api/v1/recommendations/weekly-history"),
            ApiTokenPolicy.allow(HttpMethod.GET, "/api/web/recommendations"),
            ApiTokenPolicy.allow(HttpMethod.GET, "/api/web/recommendations/weekly-current"),
            ApiTokenPolicy.allow(HttpMethod.GET, "/api/web/recommendations/weekly-history"),
