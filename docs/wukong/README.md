...
```text
http://test.example.invalid:3002/wukong
```
...
```text
https://skillhub.example.invalid/wukong
```
...
await callBridge('skill.installFromUrl', {
  url: 'https://skillhub.example.invalid/api/v1/skills/global/skillhub/versions/1.1.7/download',
  name: 'skillhub',
})
```
...
```text
https://skillhub.example.invalid/api/v1/skills/global/skillhub/versions/1.1.7/download
```
...
```text
https://skillhub.example.invalid/api/wukong/skill-provider
```
